...
*-If 'h' or '--help' option is present print help message and
*exit. help message should contain brief desciption about the program,
*what it does and how to use it.
*-If value to 'n' option is not supplied; show the usage
* -If value to n is supplied as Command line argument, continue
*reading 'n' objects
*/
package com.shabir;
